...
-- CreateIndex: Case-insensitive unique constraint on domain
-- Prevents duplicate domains (e.g., "Example.com" and "example.com" are treated as the same)
-- This is the primary uniqueness constraint for the waitlist (one company = one entry)
