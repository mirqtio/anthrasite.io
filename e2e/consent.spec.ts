...
test.describe('Cookie Consent Flow', () => {
  ...
  test('should show consent banner on first visit', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: 'Reject all cookies' })).toBeVisible()
  ...
  test('should hide banner after rejecting all cookies', async ({ page }) => {
    ...
    const analyticsCookies = cookies.filter(c => 
      c.name.startsWith('_ga') || c.name.startsWith('ph_')
    )
  ...
  test('should close preferences modal when clicking backdrop', async ({ page }) => {
    await page.getByRole('button', { name: 'Manage cookie preferences' }).click()
  ...
  test('should load analytics scripts only after consent', async ({ page }) => {
    ...
    const gaScriptAfter = await page.locator('script[src*="googletagmanager.com"]').count()
  ...
  test('should be keyboard accessible', async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: 'Manage cookie preferences' })).toBeFocused()
