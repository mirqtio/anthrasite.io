...
export function PurchaseHomepage() {
  ...
  return (
    <>
      ...
      <main>
      {/* Hero Section */}
      <section className="hero" data-testid="purchase-hero">
        <div className="hero-content container-narrow">
          ...
          <div className="" data-testid="pricing-card">
            <button
      ...
      <section id="preview" className="section" data-testid="report-preview">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-header text-center">Your Top 3 Issues</h2>

          <div className="assessment-grid" data-testid="trust-signals">
