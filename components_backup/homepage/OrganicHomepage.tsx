...
export function OrganicHomepage() {
  ...
  return (
    <>
      ...
      {/* Assessment Section */}
      <section id="assessment" className="section" data-testid="features-section">
          ...
          <div className="space-y-0">
            {[
              ...
              >
                ...
                <div className="faq-answer" data-testid={`faq-answer-${index}`}>{item.a}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="modal-container container-form">
          ...
          {!showSuccess ? (
            ...
            <div className="carbon-container text-center" data-testid="waitlist-success">
          ...
          {error && (
            <p className="mt-4 text-sm text-red-500 text-center" data-testid="waitlist-error">{error}</p>
          )}
        </div>
      </div>
      ...
      <button
        className="fixed bottom-8 right-8 w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center transition-all duration-300 opacity-0"
