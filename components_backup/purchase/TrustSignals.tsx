...
const testimonials: Testimonial[] = [
  {
    ...
    content:
      'The Anthrasite report revealed issues we had no idea existed. We implemented their recommendations and saw a 40% increase in organic traffic within 3 months.',
    rating: 5,
  },
  {
    ...
    company: 'GrowthCo',
    content:
      'Worth every penny. The detailed analysis helped us prioritize our development roadmap and improve our conversion rate by 25%.',
    rating: 5,
  },
  {
    name: 'Emily Thompson',
    ...
    content:
      'The security vulnerabilities they found saved us from a potential disaster. Their report is incredibly thorough and actionable.',
    rating: 5,
  },
]
...
export function TrustSignals() {
  return (
    <section className="py-16 md:py-24" data-testid="trust-signals">
      <div className="px-10 max-w-[1200px] mx-auto">
        ...
        >
          ...
          <div className="text-center">
            <div className="text-[48px] font-light text-accent mb-2">98%</div>
            <p className="text-[17px] opacity-60">Satisfaction Rate</p>
          </div>

          <div className="text-center">
            <div className="text-[48px] font-light text-accent mb-2">4.9/5</div>
            <p className="text-[17px] opacity-60">Average Rating</p>
          </div>

          <div className="text-center">
            <div className="text-[48px] font-light text-accent mb-2">24hr</div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-12">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[17px] opacity-60">
