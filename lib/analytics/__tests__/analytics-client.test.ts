...
describe('Analytics Client', () => {
  ...
  describe('trackEvent', () => {
    it('should track event when analytics is available', () => {
      ...
      expect(mockAnalyticsManager.track).toHaveBeenCalledWith('test_event', { value: 100 })
  ...
  describe('trackWebVitals', () => {
    ...
    it('should skip undefined metrics', () => {
      ...
      expect(mockAnalyticsManager.track).not.toHaveBeenCalledWith('web_vitals', {
        metric_name: 'FID',
  ...
  describe('getFeatureFlag', () => {
    it('should get feature flag value when analytics is available', () => {
      ...
      expect(mockAnalyticsManager.getFeatureFlag).toHaveBeenCalledWith('test-flag')
    })
  ...
  describe('isFeatureEnabled', () => {
    it('should check if feature is enabled when analytics is available', () => {
      ...
      expect(mockAnalyticsManager.isFeatureEnabled).toHaveBeenCalledWith('test-feature')
    })
