...
export function CTAButton() {
  const { variantId, trackEvent, trackConversion } = useExperimentTracking('cta-color');
  ...
  return (
    <button
      ...
      className={`px-8 py-4 text-white rounded-lg ${
        buttonStyles[variantId as keyof typeof buttonStyles] || buttonStyles.blue
      }`}
    >
      Get Started
    </button>
  ...
  return (
    <div className="prose max-w-3xl mx-auto">
      <p className="text-lg leading-relaxed">
        ...
        performance optimization insights, and competitive intelligence
        to give you a complete picture of your site's potential.
      </p>
      <p className="text-lg leading-relaxed mt-4">
        We analyze Core Web Vitals, identify ranking opportunities,
        and provide actionable recommendations that can dramatically
...
export async function ServerSideHero({ experimentAssignments }: {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8">
              Get a comprehensive audit that reveals exactly how to
              improve your site's performance, SEO, and conversions.
            </p>
            <CTAButton />
          </div>
          <div>
