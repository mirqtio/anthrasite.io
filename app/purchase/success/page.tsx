...
async function SuccessContent({ sessionId, isDev }: { sessionId: string; isDev: boolean }) {
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-yellow-100 border border-yellow-200 rounded-lg p-3 mb-6">
            <p className="text-sm text-yellow-800">
              <strong>Development Mode:</strong> This is a simulated success page
            </p>
          </div>
          ...
          <p className="text-gray-600 mb-8">
            Thank you for your purchase. Your comprehensive website audit report for {businessName} is being generated.
          </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-700">
                    You'll receive an email at <strong>{customerEmail}</strong> within 24 hours
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
