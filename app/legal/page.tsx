    ...
    <div>
      ...
      <main className="pt-[120px] pb-[60px] px-10">
        <div className="max-w-[800px] mx-auto prose prose-invert">
          <h1 className="text-[48px] font-light mb-8">
          ...
          <h2 className="text-[32px] font-light mt-12 mb-6">
            1. Privacy Policy
          </h2>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            <strong>anthrasite.com</strong> or purchase our website‑audit
            ...
            <tbody>
              <tr className="border-b border-white/10">
                ...
                <td className="py-3 opacity-80">
                  Name, business email, billing address, payment method, URLs
                  you ask us to analyze, support requests, survey responses
                </td>
              ...
              <tr className="border-b border-white/10">
                ...
                <td className="py-3 opacity-80">
                  IP address, device/browser type, referring pages, pages
                  viewed, time spent, error logs
                </td>
                <td className="py-3 opacity-80">
          ...
          <blockquote className="border-l-4 border-accent pl-6 my-6 text-[17px] opacity-80">
            <strong>Cookies & tracking</strong> – We use first‑party cookies and
            Google Analytics 4 to understand how visitors use the site and to
            improve performance. You can reject non‑essential cookies in the
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            <strong>legitimate interests</strong> (e.g., improving our
            Services), <strong>consent</strong> (for optional cookies &
            marketing), and <strong>legal obligation</strong>.
          </p>
          ...
          <ul className="list-disc pl-6 text-[17px] opacity-80 space-y-2 mb-6">
            <li>
              ...
              cloud hosting (AWS), analytics (Google), and email delivery
              (Postmark), bound by confidentiality agreements.
            </li>
            <li>
              <strong>Corporate events</strong> – merger, acquisition, or asset
              sale.
            </li>
            <li>
            ...
            <li>
              We <strong>never sell</strong> customer data to third parties.
            </li>
          </ul>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            Audit artifacts are retained for <strong>18 months</strong> by
            default, after which they are permanently deleted or anonymized
            unless we are legally required to retain them longer.
          </p>

          <h3 className="text-[24px] font-light mt-8 mb-4">1.7 Security</h3>
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            We follow industry best practices: TLS 1.2+, least‑privilege access,
            encrypted backups, and regular penetration testing. No internet
            transmission is 100 % secure; use the Service at your own risk.
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            processing. Email <strong>privacy@anthrasite.com</strong> to
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            We are headquartered in New York, USA, and may transfer data to the
            United States and other countries with adequate safeguards such as
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            changes are material, provide a prominent notice or email 30 days
            before they take effect.
          </p>

          <h3 className="text-[24px] font-light mt-8 mb-4">1.12 Contact Us</h3>
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            Email: <strong>privacy@anthrasite.com</strong>
            <br />
            Mail: Entrainment Inc., 99 Madison Ave #1234, New York, NY 10016,
            USA
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            By accessing <strong>anthrasite.com</strong> or purchasing a report,
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            contract. You represent that you are using the Service for business
            purposes and have authority to bind the entity you represent.
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            responsible for safeguarding your login credentials. All fees are
            quoted in USD; payment is due at checkout via Stripe.
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            non‑transferable license to use the delivered report internally or
            with service providers working on your behalf. Anthrasite retains
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            You will not (a) reverse engineer or resell the Service, (b) submit
            URLs you do not own or have permission to audit, or (c) use the
            Service to infringe, harass, or violate any law.
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6 italic">
            ...
            information you supply. Results are <strong>not guaranteed</strong>,
            and Anthrasite disclaims all warranties, express or implied,
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            under these Terms will not exceed the amount you paid for the
            Services in the 12 months preceding the claim. Anthrasite is{' '}
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            You agree to defend and indemnify Anthrasite against any claims
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            ...
            excluding conflict‑of‑law rules. Any dispute will be resolved by
            binding arbitration under JAMS in New York County, unless you opt
            out within 30 days of first agreeing to these Terms.
          </p>
          ...
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            If any provision is unenforceable, the remaining provisions will
            remain in effect. These Terms constitute the entire agreement
            between you and Anthrasite regarding the Service.
          </p>

          <h3 className="text-[24px] font-light mt-8 mb-4">2.15 Contact</h3>
          <p className="text-[17px] opacity-80 leading-relaxed mb-6">
            Questions? Email <strong>support@anthrasite.com</strong> or write to
            the address above.
          </p>
          ...
          <blockquote className="border-l-4 border-white/20 pl-6 my-6 text-[17px] opacity-60">
            ...
            informational purposes and does not constitute legal advice. Consult
            qualified counsel to adapt these terms to your specific
            circumstances.
          </blockquote>
        </div>
      </main>
