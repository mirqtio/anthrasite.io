...
async function quickTest() {
  ...
  try {
    ...
    console.log('✓ Features section found:', await featuresSection.count() > 0);
    ...
    await page.waitForSelector('[data-testid="waitlist-form"]', { timeout: 5000 });
    console.log('✓ Waitlist form opens successfully');
    
    const emailInput = await page.locator('[data-testid="waitlist-email-input"]');
    const submitButton = await page.locator('[data-testid="waitlist-submit-button"]');
    ...
    await page.goto('http://localhost:3333/?utm=dev-utm-valid', { waitUntil: 'networkidle', timeout: 30000 });
