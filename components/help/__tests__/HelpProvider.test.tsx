...
import { HelpWidgetProvider, useHelpWidget, useHelpWidgetAvailable } from '../HelpProvider';
...
describe('HelpWidgetProvider', () => {
  ...
  describe('useHelpWidget Hook', () => {
    ...
    it('should update config', () => {
      ...
      expect(result.current.config.enableSearch).toBe(DEFAULT_HELP_CONFIG.enableSearch);
    });
