...
describe('HelpWidget Performance', () => {
  ...
  describe('Render Performance', () => {
    it('should render quickly with many FAQs', async () => {
      ...
      (faqService.getFAQsForContext as jest.Mock).mockReturnValue(manyFAQs.slice(0, 15));
    ...
    it('should limit displayed FAQs for performance', async () => {
      ...
      await waitFor(() => {
        ...
        const faqButtons = screen.getAllByRole('button', { name: /Question \d+/ });
  ...
  describe('Search Performance', () => {
    ...
    it('should handle large search results efficiently', async () => {
      ...
      await waitFor(() => {
        const results = screen.getAllByRole('button', { name: /Result Question \d+/ });
  ...
  describe('Virtual Scrolling', () => {
    it('should handle scrolling performance with many items', async () => {
      ...
      await waitFor(() => {
        const scrollContainer = screen.getByRole('dialog').querySelector('[role="list"]');
