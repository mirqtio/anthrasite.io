...
import { usePurchaseFunnelTracking, useRenderTracking } from '@/lib/monitoring/hooks'
      ...
      <nav className="nav-fixed">
        <div className="max-w-[1200px] mx-auto px-10 py-5 flex justify-between items-center">
          ...
          <ul className="hidden md:flex gap-10 list-none">
            <li><a href="#preview" className="text-white no-underline text-[24px] font-normal opacity-70 hover:opacity-100 transition-opacity duration-300">Report Preview</a></li>
      ...
      <section className="hero" data-testid="purchase-homepage">
        <div className="hero-content container-narrow">
          ...
          <p className="text-[24px] font-normal opacity-70 mb-[60px] max-w-[700px] mx-auto">
            We've identified critical improvements worth thousands in monthly revenue.
          </p>
          ...
          <button onClick={handleGetReport} disabled={redirecting} className="cta-primary">
          ...
          <div className="assessment-grid">
            <div className="text-center">
              ...
              <p className="text-[14px] opacity-60 leading-[1.6]">
                Critical headers absent. Leaving your site vulnerable to XSS attacks
                and data breaches.
              </p>
              <p className="text-[16px] text-accent mt-3">Impact: -15% trust score</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[14px] opacity-60 leading-[1.6]">
                68% slower than competitors. Every second costs you
                7% in conversions.
              </p>
              <p className="text-[16px] text-accent mt-3">Impact: -$3,200/month</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[14px] opacity-60 leading-[1.6]">
                23 unoptimized images adding 2.8MB. Mobile users
                are bouncing before load.
              </p>
              <p className="text-[16px] text-accent mt-3">Impact: -$1,800/month</p>
            </div>
          </div>

          <p className="text-center opacity-60 text-[18px] mt-12">
            Your full report includes specific fixes for each issue with implementation priority.
          </p>
        </div>
      </section>
      ...
      <Card variant="bordered" className="max-w-md text-center">
        <div className="p-8 space-y-4">
          ...
          <p className="text-anthracite-black/60">
            {error || 'This purchase link is not valid. Please check your email for the correct link.'}
          </p>
...
function ScoreCard({ label, score, color }: ScoreCardProps) {
  ...
  return (
    <div className="text-center">
      ...
      <p className={`mt-2 text-3xl font-bold rounded-lg py-2 ${colorClasses[color]}`}>
        {score}
      </p>
    </div>
  )
...
const defaultIssues: ReportIssue[] = [
  {
    ...
    description: 'Your site is missing critical security headers that protect against XSS attacks.',
  },
  {
    severity: 'medium',
    title: 'Slow Page Load Speed',
    description: 'Main page takes 4.2s to load. Google recommends under 2.5s for optimal user experience.',
  },
  {
    severity: 'low',
    title: 'Images Not Optimized',
    description: '23 images could be compressed to reduce page weight by up to 65%.',
  },
]
