...
export function CTASection({
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      {/* Main CTA Card */}
      <div
        className="relative p-8 min-[800px]:p-10 bg-white rounded-2xl shadow-lg ring-1 ring-black/5 overflow-hidden"
        style={{
      ...
      >
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-10 min-[800px]:grid min-[800px]:grid-cols-2 min-[800px]:gap-12">
            ...
            <div className="flex flex-col gap-8">
              ...
              <p className="text-[24px] tracking-[0.02em]">
                <span className="text-slate-500">Your report for </span>
                <span className="text-slate-900 font-semibold">{company}</span>
              </p>

              {/* Bullets */}
              <ul className="flex flex-col gap-4 text-[18px] min-[800px]:text-[20px] text-slate-600 tracking-[0.02em]">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-slate-900 text-[18px] min-[800px]:text-[20px] font-medium leading-[1.6] tracking-[0.02em]">
          ...
          <div className="p-6 bg-slate-50 rounded-xl ring-1 ring-slate-200">
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <Shield
                  ...
                  aria-hidden="true"
                />
                <span className="text-slate-900 text-[14px] font-semibold uppercase tracking-wider">
                  The report pays for itself or it&apos;s free
                </span>
              </div>
              <p className="text-slate-600 text-[16px] leading-[1.6] tracking-[0.02em]">
