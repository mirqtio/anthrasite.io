...
// Official "Powered by Stripe" badge (from Stripe brand assets)
...
export function SecureCheckout({ darkMode = false }: SecureCheckoutProps) {
  const colorClass = darkMode ? 'text-white/50' : 'text-slate-500'

  return (
    <div className={`flex items-center justify-center gap-3 ${colorClass}`}>
      <PoweredByStripe className="h-[30px] w-auto" />
