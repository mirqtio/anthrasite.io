...
describe('TrustSignals', () => {
  ...
  it('renders all testimonials', () => {
    ...
    expect(screen.getByText(/40% increase in organic traffic/)).toBeInTheDocument()
    expect(screen.getByText(/improve our conversion rate by 25%/)).toBeInTheDocument()
    expect(screen.getByText(/security vulnerabilities they found/)).toBeInTheDocument()
  })
  ...
  it('renders payment security message', () => {
    ...
    expect(screen.getByText('Your payment is secure and protected')).toBeInTheDocument()
  })
