...
describe('ReportPreview', () => {
  ...
  it('renders what\'s included sections', () => {
    ...
    expect(screen.getByText(/50\+ page comprehensive report/)).toBeInTheDocument()
  ...
  it('references the domain in the header', () => {
    ...
    expect(screen.getByText(/Here's a preview of what we discovered about example.com/)).toBeInTheDocument()
  })
})