...
/**
 * Legacy success page for backward compatibility with payment_intent and purchase flows.
 * New session_id flow uses the personalized SuccessPageClient instead.
 */
export function LegacySuccessPage({
  sessionId,
  paymentIntentId,
  purchaseId,
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#232323] text-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <a
            href="/purchase"
            className="inline-flex items-center px-6 py-3 bg-[#0066FF] text-white rounded-lg font-medium hover:bg-[#0052CC] transition-colors"
          >
            Try Again
          </a>
        </div>
          ...
          <div className="bg-[#141414] border border-white/10 rounded-lg p-8 mb-8">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start">
                <span className="text-[#0066FF] font-bold mr-3">1.</span>
                <div>
              ...
              <div className="flex items-start">
                <span className="text-[#0066FF] font-bold mr-3">2.</span>
                <div>
              ...
              <div className="flex items-start">
                <span className="text-[#0066FF] font-bold mr-3">3.</span>
                <div>
                  <p className="font-medium">Report Delivery</p>
                  <p className="text-white/60 text-sm">
                    You&apos;ll receive your comprehensive PDF report via email
                    once complete.
                  </p>
                </div>
              </div>
