...
describe('WaitlistForm', () => {
  ...
  it('should render domain input initially', () => {
    ...
    expect(screen.getByLabelText(/enter your website domain/i)).toBeInTheDocument()
  ...
  it('should show suggestion for domain typos', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByRole('button', { name: 'gmail.com' })).toBeInTheDocument()
    })
  })
  ...
  it('should handle signup errors', async () => {
    ...
    mockFetch.mockResolvedValueOnce({
      ok: false,
      json: async () => ({ error: 'Unable to add to waitlist. Please try again.' }),
    } as Response)
    ...
    await waitFor(() => {
      const errorElement = screen.getByText('Unable to add to waitlist. Please try again.')
